...
export const docs = await create.docs("docs", "content/docs", {"meta.json": __fd_glob_0, }, {"components.mdx": __fd_glob_1, "configuration.mdx": __fd_glob_2, "getting-started.mdx": __fd_glob_3, "index.mdx": __fd_glob_4, });